...
import { ProviderPlatformSettingsSection } from './ProviderPlatformSettingsSection';
...
export const SETTINGS_SECTION_DEFINITIONS: SettingsSectionDefinition[] = [
  ...
  { id: 'providers', icon: PuzzlePieceIcon, group: 'host' },
  { id: 'ssh', icon: TerminalWindowIcon, group: 'universal' },
...
export function renderSettingsSection(
  ...
  switch (type) {
    ...
    case 'providers':
      return <ProviderPlatformSettingsSection />;
    case 'ssh':
      return <SshHostsSettingsSection />;
    default:
      return <GeneralSettingsSection />;
  }
}
