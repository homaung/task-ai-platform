...
export type ProviderPlugin = { id: string, plugin_key: string, display_name: string, version: string, vendor: string | null, description: string | null, manifest_path: string, adapter_entrypoint: string, configuration_schema: unknown, credential_schema: unknown, capabilities: Array<string>, runtime_types: Array<string>, permissions: Array<string>, status: string, enabled: boolean, installed_at: string, updated_at: string, };

export type CreateProviderPlugin = { plugin_key: string, display_name: string, version: string, vendor: string | null, description: string | null, manifest_path: string, adapter_entrypoint: string, configuration_schema: unknown, credential_schema: unknown, capabilities: Array<string>, runtime_types: Array<string>, permissions: Array<string>, };

export type ProviderAccount = { id: string, provider_plugin_id: string, display_name: string, account_type: string, credential_reference: string | null, configuration_json: unknown, status: string, enabled: boolean, last_validated_at: string | null, created_at: string, updated_at: string, };

export type CreateProviderAccount = { provider_plugin_id: string, display_name: string, account_type: string, credential_reference: string | null, configuration_json: unknown, };

export type ModelDefinition = { id: string, provider_account_id: string, provider_model_key: string, display_name: string, description: string | null, context_window: bigint | null, input_modalities: Array<string>, output_modalities: Array<string>, capability_json: Array<string>, pricing_json: unknown, availability_status: string, discovered_automatically: boolean, enabled: boolean, created_at: string, updated_at: string, };

export type CreateModelDefinition = { provider_account_id: string, provider_model_key: string, display_name: string, description: string | null, context_window: bigint | null, input_modalities: Array<string>, output_modalities: Array<string>, capabilities: Array<string>, pricing_json: unknown, discovered_automatically: boolean, };

export type RuntimeProfile = { id: string, provider_account_id: string, name: string, runtime_type: string, executable_path: string | null, endpoint: string | null, remote_connection_id: string | null, working_directory_policy: string, environment_reference: string | null, configuration_json: unknown, enabled: boolean, created_at: string, updated_at: string, };

export type CreateRuntimeProfile = { provider_account_id: string, name: string, runtime_type: string, executable_path: string | null, endpoint: string | null, remote_connection_id: string | null, working_directory_policy: string, environment_reference: string | null, configuration_json: unknown, };

export type ProviderPermissionPolicy = { id: string, name: string, description: string | null, approved_permissions: Array<string>, constraints_json: unknown, created_at: string, updated_at: string, };

export type CreateProviderPermissionPolicy = { name: string, description: string | null, approved_permissions: Array<string>, constraints_json: unknown, };

export type AgentProfile = { id: string, name: string, description: string | null, role_key: string, system_instructions: string, compatible_capabilities: Array<string>, preferred_provider_plugin_id: string | null, preferred_model_id: string | null, allowed_tools: Array<string>, denied_tools: Array<string>, permission_policy_id: string | null, context_policy_json: unknown, enabled: boolean, created_at: string, updated_at: string, };

export type CreateAgentProfile = { name: string, description: string | null, role_key: string, system_instructions: string, compatible_capabilities: Array<string>, preferred_provider_plugin_id: string | null, preferred_model_id: string | null, allowed_tools: Array<string>, denied_tools: Array<string>, permission_policy_id: string | null, context_policy_json: unknown, };

export type Assignment = { id: string, task_id: string, provider_plugin_id: string, provider_account_id: string, model_definition_id: string | null, runtime_profile_id: string, agent_profile_id: string, permission_policy_id: string | null, required_capabilities: Array<string>, status: string, assigned_by: string, assigned_at: string, started_at: string | null, ended_at: string | null, handoff_from_assignment_id: string | null, handoff_reason: string | null, };

export type CreateAssignment = { task_id: string, provider_plugin_id: string, provider_account_id: string, model_definition_id: string | null, runtime_profile_id: string, agent_profile_id: string, permission_policy_id: string | null, required_capabilities: Array<string>, assigned_by: string | null, handoff_from_assignment_id: string | null, handoff_reason: string | null, };

export type ProviderSession = { id: string, assignment_id: string, provider_session_reference: string | null, provider_thread_reference: string | null, external_session_reference: string | null, resume_strategy: string, mode: string, status: string, context_package_id: string | null, started_at: string, ended_at: string | null, last_message_at: string | null, summary: string | null, provider_metadata_json: unknown, error_code: string | null, error_message: string | null, };

export type ProviderSessionEvent = { id: string, session_id: string, event_type: string, payload_json: unknown, created_at: string, };

export type ProviderPluginManifest = { schemaVersion: string, id: string, name: string, version: string, vendor: string | null, description: string | null, entrypoint: string, configurationSchema: unknown, credentialSchema: unknown, capabilities: Array<string>, runtimeTypes: Array<string>, permissions: Array<string>, };

export type ProviderPluginRequest = { id: string, method: string, params: unknown, };

export type ProviderPluginResponse = { id: string, result: unknown, error: ProviderProtocolError | null, };

export type ProviderProtocolError = { code: string, message: string, details: unknown, };
...
export type ProviderPlatformSnapshot = { plugins: Array<ProviderPlugin>, accounts: Array<ProviderAccount>, models: Array<ModelDefinition>, runtimes: Array<RuntimeProfile>, permission_policies: Array<ProviderPermissionPolicy>, agent_profiles: Array<AgentProfile>, assignments: Array<Assignment>, sessions: Array<ProviderSession>, };

export type InstallProviderPluginRequest = { directory: string, };

export type AssignmentValidation = { valid: boolean, available_capabilities: Array<string>, missing_capabilities: Array<string>, missing_permissions: Array<string>, warnings: Array<string>, };

export type CreateAssignmentResponse = { assignment: Assignment, validation: AssignmentValidation, };

export type StartProviderSessionRequest = { assignment_id: string, context_package_id: string | null, mode: string, input: unknown, };

export type StartProviderSessionResponse = { session: ProviderSession, adapter_result: unknown, };

export type SshHostSummary = { alias: string, hostname: string, user: string | null, port: number | null, identity_files: Array<string>, };

export type SshHostsResponse = { ssh_available: boolean, config_path: string | null, hosts: Array<SshHostSummary>, };

export type InspectSshHostRequest = { alias: string, };

export type SshRemoteTool = { name: string, path: string, };

export type SshConnectionInfo = { alias: string, home_dir: string, shell: string, tools: Array<SshRemoteTool>, repositories: Array<string>, };

export type SshLaunchTool = "shell" | "claude" | "codex";

export type AiRoomEndpointState = { configured: boolean, available: boolean, instruction_installed: boolean, error: string | null, };
